...
///////////////////////////////////////////////////////////////////////////////
// Création et ajout du menu avec racourcis et icones
///////////////////////////////////////////////////////////////////////////////
...
static void startApplication(GtkApplication *app,gpointer data) {
  ...
  gtk_window_set_title(GTK_WINDOW(window),"MasterMind v1.3");
...
int main(int argc,char *argv[]) {
  ...
  GtkApplication *app=gtk_application_new("fr.iutbeziers.menus-13",
